...
func (self *NailgunConnection) sendArguments() (err error) {
...
func (self *NailgunConnection) sendCommand() (err error) {
	command := os.Args[1]
...
func main() {
	...
	exitCode, err := ng.readFromServer()
	ng.close()
